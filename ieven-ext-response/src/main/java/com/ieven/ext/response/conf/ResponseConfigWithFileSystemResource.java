 ...
 *
 */
public class ResponseConfigWithFileSystemResource extends AbstractRegisterConfigWithFileSystemResource {
	...
	public ResponseConfigWithFileSystemResource() {
		// 用来设定需要进行的注册类型
		this(RegistType.SPECIFIC);
	}

	private ResponseConfigWithFileSystemResource(RegistType registType) {
		super(registType);
